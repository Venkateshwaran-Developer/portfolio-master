...
const SkillsSection = () => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      ...
      <h2 className="text-2xl md:max-w-4xl w-full seq mt-2">
        I like to take responsibility to craft aesthetic user experience using
        modern frontend architecture and rapid responsive backend architecture and easily accessible databases.
      </h2>
    </div>
  );
